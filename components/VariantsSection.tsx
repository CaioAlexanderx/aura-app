  ...
  async function handleSave() {
    ...
    try {
      await companiesApi.createVariant(company.id, productId, {
        sku_suffix: '', // auto-generated by backend
            ...
            <View key={v.id || i} style={s.variantRow}>
              <View style={{ flex: 1 }}>
                <Text style={s.varLabel}>
                  {v.attributes?.map(a => a.value).join(' / ') || v.sku_suffix}
                </Text>
...
const s = StyleSheet.create({
  ...
  varSku: { fontSize: 9, color: Colors.ink3, marginTop: 1, fontFamily: 'monospace' as any },
