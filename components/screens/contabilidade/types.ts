...
export const AURA_AUTO_FEATURES: Record<string, AutoFeature[]> = {
  mei: [
    ...
    { name: "Alertas de vencimento", desc: "Notificações automáticas 15, 7 e 3 dias antes de cada vencimento.", icon: "!" },
    { name: "Resumo gerencial", desc: "Relatório mensal gerado automaticamente com receitas, despesas e resultado.", icon: "#" },
  ],
  simples: [
    { name: "Alertas de vencimento", desc: "Notificações automáticas 15, 7 e 3 dias antes de cada vencimento.", icon: "!" },
    { name: "Resumo gerencial", desc: "Relatório mensal gerado automaticamente com dados financeiros.", icon: "#" },
    { name: "Monitor Fator R", desc: "Acompanha pro-labore vs receita para manter enquadramento no Anexo III.", icon: "F" },
  ],
};

export const TABS = ["Visao Geral", "Obrigações", "Guias", "Histórico"];
...
export const FILTER_CONFIG: Record<FilterLabel, { bg: string; color: string; label: string }> = {
  ...
  voce_faz: { bg: Colors.amberD, color: Colors.amber, label: "Você faz" },
};
  ...
  return [
    {
      ...
      aura_action: "O DAS MEI tem valor fixo. A Aura gera o QR Code para você pagar em segundos.",
      ...
      steps: [
        {
          ...
          auto: true,
          hint: "Valor fixo mensal: INSS + ISS/ICMS conforme seu CNAE. Nenhum cálculo necessário.",
          doc_type: "pdf",
    ...
    {
      code: "dasn_simei", name: "DASN-SIMEI (declaração anual)", frequency: "anual", due_date: dasnDue,
      filter_label: "voce_faz",
      aura_action: "Aura consolida seu faturamento anual. Você confere e transmite no portal.",
      ...
      steps: [
        { text: "Aura consolida faturamento anual", auto: true, hint: "Soma de todas as notas emitidas no ano", doc_type: "pdf", doc_note: "Relatório anual de faturamento" },
        { text: "Acesse o portal DASN-SIMEI", auto: false, hint: "Use seu CNPJ e código de acesso", portal_url: PORTALS.dasn.url, portal_label: "Abrir DASN-SIMEI", doc_type: "gif", doc_note: "Como acessar a DASN" },
        { text: "Informe CNPJ e código de acesso", auto: false, hint: "O código e obtido no portal do Simples Nacional", doc_type: "gif", doc_note: "Tela de login" },
        { text: "Confira valores (compare com o relatório da Aura)", auto: false, hint: "Os valores devem bater", doc_type: "gif", doc_note: "Tela de conferência" },
  ...
  const obls: Obligation[] = [
    {
      ...
      steps: [
        { text: "Aura apura receita bruta do mês (notas emitidas)", auto: true, hint: "Baseado nas notas fiscais", doc_type: "pdf", doc_note: "Relatório receita mensal" },
        { text: "Calcula DAS conforme seu anexo (III ou V) e Fator R", auto: true, hint: "Considera pro-labore e folha", doc_type: "pdf", doc_note: "Demonstrativo cálculo DAS" },
        { text: "Gera guia DAS para pagamento", auto: true, hint: "Boleto ou Pix disponível", doc_type: "pdf", doc_note: "Guia DAS" },
        { text: "Pagar a guia", auto: false, hint: "Via app bancario, Pix ou boleto" },
      ],
    },
    {
      code: "pgdas_d", name: "PGDAS-D (transmitir declaração)", frequency: "mensal", due_date: dasDue,
      filter_label: "voce_faz",
      aura_action: "Aura calcula o DAS estimado. Você confere os valores e transmite no portal.",
      ...
      steps: [
        { text: "Aura apura receita bruta e calcula DAS estimado", auto: true, hint: "Resumo disponível para conferência", doc_type: "pdf", doc_note: "Resumo para conferência" },
        ...
        { text: "Login com certificado digital ou código de acesso", auto: false, hint: "Certificado A1 ou código obtido no e-CAC", portal_url: PORTALS.ecac.url, portal_label: "Abrir e-CAC", doc_type: "gif", doc_note: "Tela de login" },
        { text: "Preencha a receita bruta do período", auto: false, hint: "Use o valor calculado pela Aura", doc_type: "gif", doc_note: "Preenchimento receita" },
        { text: "Confira o cálculo e clique em Transmitir", auto: false, hint: "Compare com o demonstrativo da Aura", doc_type: "gif", doc_note: "Tela de transmissão" },
        { text: "Imprima o DAS gerado e pague", auto: false, hint: "Boleto disponível para impressão", doc_type: "gif", doc_note: "Imprimir guia" },
      ],
    },
    {
      ...
      alert_level: alertFor(dasDays), days_until_due: dasDays,
      steps: [
        { text: "Aura calcula pro-labore mínimo (Fator R)", auto: true, hint: "Pro-labore >= 28% da receita para Anexo III", doc_type: "pdf", doc_note: "Holerite sócio" },
        ...
        { text: "Pague a guia", auto: false, hint: "Via Pix, boleto ou débito" },
      ],
    },
    {
      code: "defis", name: "DEFIS (declaração anual)", frequency: "anual", due_date: defisDue,
      filter_label: "voce_faz",
      aura_action: "Aura consolida todos os dados do ano e prepara um resumo para conferência.",
      user_action: "Transmitir no portal do Simples Nacional",
      status: "future", checkpoint_done: 0, checkpoint_total: 5,
      alert_level: null, days_until_due: defisDays,
      portal_url: PORTALS.simples.url, portal_label: PORTALS.simples.label,
      steps: [
        { text: "Aura consolida dados anuais (receita, despesa, folha)", auto: true, hint: "Relatório completo disponível", doc_type: "pdf", doc_note: "Relatório anual consolidado" },
        ...
        { text: "Login com certificado ou código de acesso", auto: false, hint: "Mesmo acesso do PGDAS-D", doc_type: "gif", doc_note: "Tela de login" },
        { text: "Confira os dados pre-preenchidos", auto: false, hint: "Compare com o relatório da Aura", doc_type: "gif", doc_note: "Tela de conferência" },
        { text: "Transmita a declaração", auto: false, hint: "Guarde o recibo de transmissão", doc_type: "gif", doc_note: "Botao transmitir" },
      ],
    },
  ];
    ...
    obls.splice(2, 0,
      {
        ...
        steps: [
          { text: "Aura calcula FGTS (8% sobre salários da folha)", auto: true, hint: "Baseado na folha do mês", doc_type: "pdf", doc_note: "Guia GRF/FGTS" },
      ...
      },
      {
        ...
        filter_label: "voce_faz",
        aura_action: "Aura prepara os dados da folha e gera o arquivo. Você envia pelo portal gov.br.",
        ...
        steps: [
          { text: "Aura prepara dados da folha e gera arquivo", auto: true, hint: "Arquivo disponível na seção Documentos", doc_type: "pdf", doc_note: "Arquivo XML + guia de envio" },
          { text: "Acesse o portal eSocial", auto: false, hint: "Portal do governo federal", portal_url: PORTALS.esocial.url, portal_label: "Abrir eSocial", doc_type: "gif", doc_note: "Página inicial eSocial" },
          ...
          { text: "Navegue até Enviar arquivo/evento", auto: false, hint: "Menu lateral do portal", doc_type: "gif", doc_note: "Navegacao no menu" },
          { text: "Selecione o arquivo gerado pela Aura", auto: false, hint: "Na pasta Downloads do seu computador", doc_type: "gif", doc_note: "Seleção de arquivo" },
          { text: "Confirme o envio e salve o recibo", auto: false, hint: "Guarde o número do recibo", doc_type: "gif", doc_note: "Confirmação de envio" },
        ],
      },
    );
  }
