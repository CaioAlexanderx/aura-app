...
// Background features (not obligations - Aura handles automatically)
...
// Only ACTIONABLE obligations — things the user or Aura needs to do periodically
export const MEI_OBLIGATIONS: Obligation[] = [
  { code: "das_mei", name: "Pagar DAS-MEI", frequency: "mensal", due_date: null, filter_label: "aura_resolve", aura_action: "Aura calcula e gera QR Code Pix. Voce so precisa pagar.", user_action: "Escanear QR Code e pagar", status: "pending", checkpoint_done: 0, checkpoint_total: 3, alert_level: null, days_until_due: null, estimated_amount: 75.90,
  ...
  { code: "dasn_simei", name: "DASN-SIMEI (declaracao anual)", frequency: "anual", due_date: null, filter_label: "voce_faz", aura_action: "Aura pre-preenche com seu faturamento anual.", user_action: "Transmitir no portal do Simples Nacional", status: "future", checkpoint_done: 0, checkpoint_total: 4, alert_level: null, days_until_due: null,
...
export const SN_OBLIGATIONS: Obligation[] = [
  { code: "das_sn", name: "Pagar DAS Simples", frequency: "mensal", due_date: null, filter_label: "aura_resolve", aura_action: "Aura calcula o DAS com base na receita e gera a guia.", user_action: "Pagar via Pix ou boleto", status: "pending", checkpoint_done: 0, checkpoint_total: 3, alert_level: null, days_until_due: null,
  ...
  { code: "pgdas_d", name: "PGDAS-D (transmitir)", frequency: "mensal", due_date: null, filter_label: "voce_faz", aura_action: "Aura calcula o DAS estimado. Voce confere e transmite.", user_action: "Transmitir no portal PGDAS-D", status: "pending", checkpoint_done: 0, checkpoint_total: 5, alert_level: null, days_until_due: null,
  ...
  { code: "fgts", name: "Pagar FGTS", frequency: "mensal", due_date: null, filter_label: "aura_resolve", aura_action: "Aura calcula FGTS com base na folha e gera a guia.", user_action: "Pagar a guia", status: "pending", checkpoint_done: 0, checkpoint_total: 2, alert_level: null, days_until_due: null,
  ...
  { code: "esocial", name: "eSocial (enviar XML)", frequency: "mensal", due_date: null, filter_label: "voce_faz", aura_action: "Aura gera o arquivo XML. Voce envia no portal gov.br.", user_action: "Enviar XML pelo portal gov.br (5 min)", status: "pending", checkpoint_done: 0, checkpoint_total: 6, alert_level: null, days_until_due: null,
  ...
  { code: "defis", name: "DEFIS (declaracao anual)", frequency: "anual", due_date: null, filter_label: "voce_faz", aura_action: "Aura consolida dados e pre-preenche a declaracao.", user_action: "Transmitir no portal do Simples", status: "future", checkpoint_done: 0, checkpoint_total: 4, alert_level: null, days_until_due: null,
  ...
  { code: "prolabore", name: "Pro-labore + GPS", frequency: "mensal", due_date: null, filter_label: "aura_resolve", aura_action: "Aura calcula pro-labore, INSS e gera guia GPS.", user_action: "Pagar a guia GPS", status: "pending", checkpoint_done: 0, checkpoint_total: 2, alert_level: null, days_until_due: null,
