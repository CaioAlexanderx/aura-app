    ...
    >
      ...
      <View style={styles.header}>
        <View style={styles.headerIconWrap}>
          <Icon name="refresh-cw" size={22} color={StudioColors.accent} />
        </View>
        <View style={{ flex: 1 }}>
      ...
      <View style={styles.card}>
        <View style={styles.cardHeader}>
          <View style={[styles.cardBadge, { backgroundColor: StudioColors.primaryGhost }]}>
            <Icon name="check-circle" size={16} color={StudioColors.primary} />
          </View>
        ...
        <View style={styles.hintRow}>
          <Icon name="info" size={12} color={StudioColors.ink3} />
      ...
      <View style={styles.card}>
        <View style={styles.cardHeader}>
          <View style={[styles.cardBadge, { backgroundColor: StudioColors.accentGhost }]}>
            <Icon name="dollar-sign" size={16} color={StudioColors.accent} />
          </View>
        ...
        {parsedMaxPreview === 0 && (
          <View style={styles.warnRow}>
            <Icon name="info" size={12} color={StudioColors.warm} />
      ...
      <View style={styles.card}>
        <View style={styles.cardHeader}>
          <View style={[styles.cardBadge, { backgroundColor: StudioColors.primaryGhost }]}>
            <Icon name="file-text" size={16} color={StudioColors.primary} />
          </View>
      ...
      <View style={styles.previewCard}>
        <View style={styles.previewHeader}>
          <Icon name="eye" size={14} color={StudioColors.accent} />
...
const styles = StyleSheet.create({
  ...
  warnRow: {
    ...
    gap: 6,
    marginTop: 8,
    backgroundColor: StudioColors.warmSoft,
  ...
  previewCard: {
    ...
    borderRadius: 14,
    borderWidth: 1,
    borderColor: StudioColors.accentSoft,
    padding: 14,
    marginBottom: 16,
  },
  previewHeader: {
