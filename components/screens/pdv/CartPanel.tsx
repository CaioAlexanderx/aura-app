...
export function CartPanel({ cart, payment, setPayment, total, itemCount, isWide, updateQty, removeItem, finalizeSale }: {
  cart: CartItem[]; payment: string; setPayment: (k: string) => void; total: number; itemCount: number;
  isWide: boolean; updateQty: (id: string, d: number) => void; removeItem: (id: string) => void; finalizeSale: () => void;
}) {
  return (
