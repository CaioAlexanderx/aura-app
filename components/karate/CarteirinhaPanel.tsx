...
// Preview do cartão. Na WEB, renderiza EXATAMENTE o mesmo HTML da impressão
// (buildSingleCardHtml) dentro de um <iframe> — garante que a visualização na
// aba Praticantes seja 1:1 com a carteirinha impressa (posições, logos,
// negritos, fontes, entrelinha). Em nativo, cai no card RN (CarteirinhaCard).
