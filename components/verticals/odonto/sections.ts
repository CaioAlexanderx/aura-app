// ============================================================
// AURA. — Odonto Sections (W2-01 + W2-02 TISS + W2-03 NFS-e + GAP-03 Materiais)
// Reagrupa tabs em secoes com sub-tabs internas.
// ============================================================
...
import { SuppliesTab } from '@/components/verticals/odonto/SuppliesTab'; // GAP-03
...
export const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    tabs: [
      ...
      { id: 'materiais',   label: 'Materiais',   component: SuppliesTab, badge: 'novo' }, // GAP-03
