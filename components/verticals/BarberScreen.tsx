...
const TABS = ['Agenda', 'Fila', 'Comissões', 'Caixa', 'Pacotes', 'Gift cards', 'Fidelidade', 'Agenda online'];
...
const SCREEN_DATA: Record<string, { kpis: KPI[]; flow: { title: string; steps: FlowStep[] }; actionLabel: string; emptyIcon: string; emptyTitle: string; emptySubtitle: string }> = {
  Agenda: {
    ...
    flow: { title: 'Fluxo do atendimento', steps: [{ label: 'Agendar' }, { label: 'Check fila' }, { label: 'Chamar' }, { label: 'Atender' }, { label: 'Finalizar' }, { label: 'Pagamento' }, { label: 'Comissão' }] },
    actionLabel: '+ Agendar',
    emptyIcon: '\uD83D\uDCC5', emptyTitle: 'Nenhum agendamento', emptySubtitle: 'Agende o primeiro cliente ou adicione na fila de espera.',
  },
  Fila: {
    kpis: [{ value: '0', label: 'Na fila', color: '#F59E0B' }, { value: '~0min', label: 'Tempo estimado', color: '#06B6D4' }, { value: '0', label: 'Atendidos hoje', color: '#10B981' }, { value: '-', label: 'Próximo disp.', color: '#7C3AED' }],
  ...
  Caixa: {
    kpis: [{ value: 'R$ 0', label: 'Entradas', color: '#10B981' }, { value: 'R$ 0', label: 'Saídas', color: '#EF4444' }, { value: 'R$ 0', label: 'Gorjetas', color: '#F59E0B' }, { value: 'R$ 0', label: 'Saldo', color: '#06B6D4' }],
    ...
    emptyIcon: '\uD83D\uDCB3', emptyTitle: 'Caixa não aberto', emptySubtitle: 'Abra o caixa do dia para registrar movimentações.',
  },
  Pacotes: {
    ...
    flow: { title: 'Tipos', steps: [{ label: 'Pacote serviços' }, { label: 'Clube mensal' }, { label: 'Gift card' }] },
    actionLabel: '+ Pacote',
    emptyIcon: '\uD83C\uDF81', emptyTitle: 'Sem pacotes', emptySubtitle: 'Crie pacotes de serviços com desconto para fidelizar clientes.',
  },
  'Gift cards': {
    ...
    emptyIcon: '\uD83C\uDF9F\uFE0F', emptyTitle: 'Sem gift cards', emptySubtitle: 'Crie vales-presente com código único para seus clientes.',
  },
  Fidelidade: {
  ...
  'Agenda online': {
    kpis: [{ value: 'Inativo', label: 'Status', color: '#9CA3AF' }, { value: '0', label: 'Solicitações', color: '#F59E0B' }, { value: '0', label: 'Confirmadas', color: '#10B981' }, { value: '-', label: 'Link', color: '#06B6D4' }],
    flow: { title: 'Fluxo', steps: [{ label: 'Cliente acessa link' }, { label: 'Escolhe serviço' }, { label: 'Escolhe horário' }, { label: 'Solicita' }, { label: 'Você confirma' }] },
    actionLabel: 'Ativar',
