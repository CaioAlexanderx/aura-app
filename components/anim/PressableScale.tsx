// ============================================================
// PressableScale — Aura · anim (promovido de karate/anim em F1 do
// redesign Crediário; o caminho antigo reexporta daqui)
//
...
export function PressableScale({
  ...
  return (
    <AnimatedPressable
      ...
      onPressOut={() => animateTo(scale, 1, Motion.fast)}
      onHoverIn={() => animateTo(hover, 0.92, Motion.fast)}
