  ...
  return (
    <View>
      <View style={{ marginBottom: 14 }}>
        ...
        <Text style={{ fontSize: 26, color: DentalColors.ink, fontWeight: "700", letterSpacing: -0.5 }}>Comunicação</Text>
        <Text style={{ fontSize: 13, color: DentalColors.ink2, marginTop: 4 }}>Recall, retorno e automações de mensagens com pacientes.</Text>
      </View>
