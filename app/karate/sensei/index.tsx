...
// practitioners) e pirâmide de faixas derivada da lista real. Tudo
// somente leitura. Padrão de loading/erro/vazio: ver eventos.tsx.
// ============================================================
...
export default function SenseiPraticantes() {
  ...
  const dojoName = SENSEI_DOJO.name;
  ...
  // oficial (beltRank), da mais alta pra mais baixa, como no mock antigo.
