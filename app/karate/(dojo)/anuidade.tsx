...
const styles = StyleSheet.create({
  ...
  soonBadgeTxt: { fontSize: 10.5, fontWeight: "600", color: KarateColors.ink3, textTransform: "uppercase", letterSpacing: 0.4 } as TextStyle,
  ...
  statusT: { fontSize: 15, fontWeight: "600" } as TextStyle,
  statusSub: { fontSize: 12.5, color: KarateColors.ink2, marginTop: 2 } as TextStyle,
  valor: { fontSize: 18, fontWeight: "400", color: KarateColors.ink, fontFamily: KarateFonts.mono } as TextStyle,
  ...
  histValor: { fontSize: 13, fontWeight: "400", color: KarateColors.ink, fontFamily: KarateFonts.mono } as TextStyle,
});
