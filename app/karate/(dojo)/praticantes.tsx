// ============================================================
// Aura Karatê (dojô) — Praticantes (F1; ex-/karate/sensei index)
// Lista dos alunos do dojô (dados reais via GET /federation/:id/dojo/
// practitioners) e pirâmide de faixas derivada da lista real. Somente
// leitura. Padrão de loading/erro/vazio: ver eventos.tsx.
// F1: nome do dojô vem do /dojo/me real (contexts/KarateDojo) — o
// fallback estático SENSEI_DOJO morreu. O banner de aquisição "Aura
// Karatê Dojô — Conhecer" foi REMOVIDO: o usuário já está no produto.
// ============================================================
...
export default function DojoPraticantes() {
  ...
  return (
    <ScrollView style={styles.scroll} contentContainerStyle={styles.content}>
      <View>
        <Text style={styles.eyebrow}>{dojoName} · {total} praticante{total === 1 ? "" : "s"}</Text>
      ...
      {!loading && !error && praticantes.length > 0 && (
        <>
          ...
          <View style={styles.search}>
            ...
            <TextInput style={styles.searchInput} value={q} onChangeText={setQ} placeholder="Buscar aluno por nome" placeholderTextColor={KarateColors.ink4} />
          </View>
          ...
          {list.length === 0 && (
            <View style={styles.stateBox}>
              ...
              <Text style={styles.stateTxt}>Nenhum aluno encontrado para "{q}".</Text>
            </View>
          )}
        </>
      )}
