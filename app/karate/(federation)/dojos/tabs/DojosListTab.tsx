// ============================================================
// DojosListTab — Aura Karatê (federação) · Shoji
//
// Aba "Dojôs" da tela de Dojôs (app/karate/(federation)/dojos/index.tsx —
// agora com abas de nível superior: "Dojôs" | "Atualização cadastral").
// Extraído do antigo index.tsx (rota única) sem mudar comportamento —
// mesmo componente, só passou a viver dentro de uma aba. O painel de
// andamento da atualização cadastral (RosterProgressPanel) SAIU daqui —
// ele não pertence mais ao índice de dojôs, mora inteiro na aba nova
// (./CadastralTab.tsx).
//
