// ============================================================
// ConexoesTab — aba "Conexões" — Aura Karatê (federação) · Shoji
//
// Extraído do antigo app/karate/(federation)/conexoes/index.tsx (H3):
// virou aba irmã de SolicitacoesTab (mesmo padrão de tabs/index.tsx da
// tela de Dojôs — ver ../index.tsx). Comportamento e visual INALTERADOS,
// só mudou de rota-única para aba.
//
