...
import { EventInstructorsManager } from "@/components/karate/EventInstructorsManager";
  ...
  return (
    <>
      ...
      >
        ...
        {/* Ministrantes e assinaturas (alimentam o certificado) */}
        <EventInstructorsManager federationId={federationId} eventId={exam.id} />
