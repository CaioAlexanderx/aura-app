...
// ============================================================
// /food/(salao)/delivery — Fase 6 (iFood Phase 1).
// UI sobre foodIfood.js (CSV import). 100% frontend.
...
export default function DeliveryScreen() {
  ...
  return (
    <View style={{ gap: 12 }}>
      <View>
        <Text style={{ fontSize: 22, fontWeight: "800", color: FoodColors.ink }}>Delivery · iFood</Text>
