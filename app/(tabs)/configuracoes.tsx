...
// CRIT-04/05: Persist config to localStorage so theme toggle doesn't wipe data
...
export default function ConfiguracoesScreen() {
  ...
  // CRIT-04/05: Hydrate from localStorage, fallback to store
  ...
  function handleSave() {
    ...
    // TODO: POST to backend when company update endpoint is ready
  }
    ...
    <ScrollView style={z.scr} contentContainerStyle={z.cnt}>
      ...
      <View style={z.saveRow}>
        <Pressable onPress={handleSave} style={[z.saveBtn, saved && z.saveBtnDone]}>
          {saved ? <View style={{ flexDirection: "row", alignItems: "center", gap: 6 }}><Icon name="check" size={16} color="#fff" /><Text style={z.saveBtnText}>Salvo!</Text></View> : <Text style={z.saveBtnText}>Salvar alteracoes</Text>}
        </Pressable>
      </View>
