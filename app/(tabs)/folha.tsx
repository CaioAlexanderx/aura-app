...
const ct=StyleSheet.create({sc:{backgroundColor:Colors.bg3,borderRadius:16,padding:20,borderWidth:1,borderColor:Colors.border2,marginBottom:20},st:{fontSize:16,color:Colors.ink,fontWeight:"700",marginBottom:16},sg:{flexDirection:"row",flexWrap:"wrap",gap:12,marginBottom:16},si:{width:IS_WIDE?"30%":"46%",backgroundColor:Colors.bg4,borderRadius:10,padding:12,gap:4},sl:{fontSize:10,color:Colors.ink3,textTransform:"uppercase",letterSpacing:0.5},sv:{fontSize:16,color:Colors.ink,fontWeight:"700"},cr:{flexDirection:"row",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:8,backgroundColor:Colors.violetD,borderRadius:10,padding:14,borderWidth:1,borderColor:Colors.border2},cl:{fontSize:13,color:Colors.ink3,fontWeight:"500"},cv:{fontSize:18,color:Colors.violet3,fontWeight:"700"},bt:{fontSize:15,color:Colors.ink,fontWeight:"700",marginBottom:12},er:{flexDirection:"row",justifyContent:"space-between",alignItems:"center",backgroundColor:Colors.bg3,borderRadius:12,padding:14,borderWidth:1,borderColor:Colors.border,marginBottom:6},ei:{gap:2},en:{fontSize:13,color:Colors.ink,fontWeight:"600"},erl:{fontSize:11,color:Colors.ink3},ens:{alignItems:"flex-end",gap:2},eb:{fontSize:12,color:Colors.ink3},el:{fontSize:13,color:Colors.green,fontWeight:"600"}});
