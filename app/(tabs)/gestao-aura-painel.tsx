...
export default function GestaoAuraPainelScreen() {
    ...
    <ScrollView style={{ flex: 1 }} contentContainerStyle={s.cnt}>
      <View style={s.header}>
        ...
        <View style={s.titleRow}>
          <View style={[s.titleIcon, { backgroundColor: Colors.greenD, borderColor: Colors.green + "44" }]}>
            <Icon name="dashboard" size={18} color={Colors.green} />
          </View>
          <View>
            <Text style={s.title}>Painel</Text>
            <Text style={s.subtitle}>MRR, churn, alertas operacionais</Text>
          </View>
        </View>
      </View>
      <DashboardAdmin />
