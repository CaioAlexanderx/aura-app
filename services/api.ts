...
export var billingApi = {
  ...
  subscribe: function(companyId: string, plan: string, billingType?: string, creditCardToken?: string, cycle?: string, holderName?: string, holderCpf?: string, holderPostalCode?: string, holderAddressNumber?: string, holderAddress?: string) {
    return request<SubscribeResponse>("/companies/" + companyId + "/billing/subscribe", { method: "POST", body: { plan: plan, billing_type: billingType || "PIX", cycle: cycle || "monthly", credit_card_token: creditCardToken, credit_card_holder_name: holderName, credit_card_holder_cpf: holderCpf, credit_card_holder_postal_code: holderPostalCode, credit_card_holder_address_number: holderAddressNumber, credit_card_holder_address: holderAddress } });
  },
