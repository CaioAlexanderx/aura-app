// fe25-whatsapp.js
// Run from aura-app root: node fe25-whatsapp.js
// FE-25: WhatsApp automações + visualização de conversas
...
// ═══════════════════════════════════════════════════
// 1. Create whatsapp.tsx
// ═══════════════════════════════════════════════════
console.log('\n=== FE-25: Creating whatsapp.tsx ===');

const whatsFile = p.join('app', '(tabs)', 'whatsapp.tsx');
...
fs.writeFileSync(whatsFile, content, 'utf-8');
console.log('  OK: whatsapp.tsx created (' + content.length + ' chars)');
total++;

// ═══════════════════════════════════════════════════
// 2. Update sidebar - enable WhatsApp
// ═══════════════════════════════════════════════════
console.log('\n=== Updating sidebar ===');
...
if (fs.existsSync(layoutFile)) {
  ...
  if (c.includes('WhatsApp", ic: "star", soon: true')) {
    c = c.replace(
      '{ r: "/whatsapp", l: "WhatsApp", ic: "star", soon: true }',
      '{ r: "/whatsapp", l: "WhatsApp", ic: "star" }'
    );
    fs.writeFileSync(layoutFile, c, 'utf-8');
    console.log('  OK: WhatsApp enabled in sidebar');
    total++;
  } else {
    console.log('  SKIP: WhatsApp sidebar pattern not found');
  }
}
...
console.log('  git add -A && git commit -m "feat: FE-25 WhatsApp - conversas, automacoes, campanhas, config" && git push');
